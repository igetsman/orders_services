...
from django.forms.widgets import Select, MultiWidget, DateInput, TextInput,HiddenInput
...
class JqSplitDateTimeWidget(MultiWidget):
    ...
    def format_output(self, rendered_widgets):
        ...
        """
        return u"Дата: %s<br/>Время: %s:%s %s" % (rendered_widgets[0], rendered_widgets[1],
